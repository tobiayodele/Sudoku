...
data = pd.read_csv(os.path.join(PROJECT_ROOT, "data", "Random", "random_sudoku_experiment.csv"))
...
plt.savefig("analysis/Random/results/percentage_relationship_random.png")
...
plt.savefig("analysis/Random/results/runtime_relationship_random.png")
...
table.to_excel("analysis/Random/results/sudoku_results_random.xlsx", index=False)
...
plt.savefig("analysis/Random/results/sudoku_results_random.png", bbox_inches="tight", dpi=300)
